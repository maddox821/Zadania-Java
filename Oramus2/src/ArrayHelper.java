 ...
 */
    ...
    public int[] interweaving(int[] ... collections) {
        int k = 0, numberOfArrays = 0, lengthOfArray = 0;
...
*/
    public int[] interweaving2(int[] ... collections) {
        int numberOfArrays = 0, resultPosition = 0, lengthOfArray = 0;
        int i = 0, j = 0;
        for(int[] array : collections){
            lengthOfArray += array.length;
            numberOfArrays++;}
        ...
        do {
            ...
            if(collections[j].length <= i){
                ...
                result[resultPosition] = collections[j][i];
                j++;}
            resultPosition++;
        } while(resultPosition < lengthOfArray);
        return result;
    }
